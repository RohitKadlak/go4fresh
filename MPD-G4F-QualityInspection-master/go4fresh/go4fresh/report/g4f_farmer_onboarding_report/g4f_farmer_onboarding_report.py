...
def get_data(conditions, filters):
	data = frappe.db.sql(
		...
		SELECT
			...
			pn.product_name as crop_name,
			pn.season as season,
			pn.irrigation_method as irrigation_method,
			pn.crop_acerage as crop_acreage,
			pn.status as status,
			pn.expected_production as expected_production_in_tonne
...
def get_columns(filters):
	columns = [
		...
		{
			"label": _("Irrigation Method"),
			"fieldname": "irrigation_method",
			"fieldtype": "Data",
			"width": 160,
		},
		{
			"label": _("Crop Acreage"),
			"fieldname": "crop_acreage",
			"fieldtype": "Float",
			"width": 160,
		},
		{
		...
		{
			"label": _("Expected Production In Tonne"),
			"fieldname": "expected_production_in_tonne",
			"fieldtype": "Data",
			"width": 160,
		},
	]
